...
class PySwitchTopo(Topo):
    ...
    def __init__(self, args):
        ...
        self.addHost('server6', **nodeconfig)
        self.addHost('switch', **nodeconfig)
        self.addHost('client', **nodeconfig)
        
        for node in ['server1','server2', 'server3', 'server4', 'server5', 'server6', 'client']:
...
def setup_addressing(net):
    ...
    reset_macs(net, 'server6', '80:00:00:00:00:{:02x}')
    ...
    set_ip(net, 'server6', 'switch', '192.168.100.7/24')
