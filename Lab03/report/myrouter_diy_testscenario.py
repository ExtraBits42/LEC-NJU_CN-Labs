...
def test_myrouter_arp_respond():
    ...
    s.add_interface("eth0", "10:00:00:00:00:01", "192.168.100.1")
    s.add_interface("eth1", "10:00:00:00:00:02", "192.168.100.2")
    s.add_interface("eth2", "10:00:00:00:00:03", "192.168.100.3")
    s.add_interface("eth3", "10:00:00:00:00:04", "192.168.100.4")
    ...
    s.expect(
        PacketInputEvent('eth0', not_arp_pkt, display=Ethernet),
    ...
    s.expect(
        PacketInputEvent('eth0', test2_pkt, display=Ethernet),
